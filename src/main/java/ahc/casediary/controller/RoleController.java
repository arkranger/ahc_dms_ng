...
import ahc.casediary.dao.services.UserRoleService;
...
public class RoleController {
    ...
    @GetMapping("/")
    public ResponseEntity<GenericResponse<PageResponse<RoleDto>>> getRoles(
    ...
    public ResponseEntity<GenericResponse<RoleDto>> getRoleById(@PathVariable("roleId") Integer roleId) {
    ...
    public ResponseEntity<GenericResponse<RoleDto>> getRoleByName(@PathVariable("roleName") String roleName) {
        RoleDto role = roleService.getRoleByRoleName(roleName);
        return ResponseEntity.ok(ResponseUtil.success(role, "role found"));
    }

    @GetMapping("/disable/{roleId}")
    public ResponseEntity<GenericResponse<?>> disableRole(
            HttpServletRequest httpRequest,
            @PathVariable("roleId") Integer roleId
    ){
        requestLogService.logRequest(httpRequest);
    ...
    public ResponseEntity<GenericResponse<?>> enableRole(
            HttpServletRequest httpRequest,
            @PathVariable("roleId") Integer roleId
    ){
        requestLogService.logRequest(httpRequest);
    ...
    public ResponseEntity<GenericResponse<UserDto>> deassignRole(
            HttpServletRequest httpRequest,
            @RequestParam(value = "username") String username,
            @RequestParam(value = "roleId") Integer roleId
    ) {
